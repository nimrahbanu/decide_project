                    ...
                    <div class="card">
                        ...
                        <div class="card-body ml-3 mr-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-container">
                                        ...
                                        <select class="form-control" id="state_id" name="state_id">
                                          <option  value="{{old('state_id')}}" disabled selected>--Select State Name--</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-container">
                                         ...
                                         <select class="form-control" id="country_id" name="country_id">
                                          <option  value="{{old('country_id')}}" disabled selected>--Select Country Name--</option>
                            ...
                            <div class="form-group col-md-12 ml-2 text-center">
                                <button class="btn btn-primary "><i class="fa fa-sign-in"></i> Submit</button>
                            </div>
                        </div>
                    </div>
                </form>    
                                                ...
                                                @foreach($prospects as $prospect)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions row">
                                                            <a  href="{{route('prospect.edit',[$prospect->id])}}" type="button" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
